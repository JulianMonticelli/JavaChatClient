...
public class EncryptionHandler {
    ...
    {
        serverPublicKey = getPublicKey(Base64.getDecoder().decode(publicKey));
    }
    ...
    public void initEncryptionHandler(String clientKey) throws NoSuchAlgorithmException,
        ...
        encryptionCipher.init(Cipher.ENCRYPT_MODE, serverPublicKey);

        decryptionCipher = Cipher.getInstance(ENC_ALG);
        decryptionCipher.init(Cipher.DECRYPT_MODE, clientPrivateKey);
        
    }
    
    public String generatePublicKeyMessage() {
        return "!!PUBK:" + new String(Base64.getEncoder().encode(clientPublicKey.getEncoded()));
    }
